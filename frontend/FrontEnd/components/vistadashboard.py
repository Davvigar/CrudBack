...
# Suprimir el warning de matplotlib sobre demasiadas figuras
...
class VistaDashboard(CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        # Configuración de Grid: 3 columnas, 5 filas (expandido para más contenido)
        self.grid_columnconfigure((0, 1, 2), weight=1)
        self.grid_rowconfigure(0, weight=0) # Fila de KPIs y estadísticas
        self.grid_rowconfigure(1, weight=2) # Fila de gráficos principales
        self.grid_rowconfigure(2, weight=2) # Fila de gráficos secundarios
        self.grid_rowconfigure(3, weight=2) # Fila de gráficos adicionales
        self.grid_rowconfigure(4, weight=1) # Fila de informes
        ...
        # Manejar casos cuando no hay datos
        ...
        # --- 2. CONFIGURACIÓN DE KPIS Y ESTADÍSTICAS ---
        
        # Fila 0: KPIs y Estadísticas de API
        ...
        # Fila 2: Ranking Comercial y Estado de Facturas
    ...
    def _add_estadisticas_api_card(self, parent_frame, estadisticas, row, col, span):
        # Tarjeta para mostrar estadísticas de la API
    ...
    def _create_matplotlib_widget(self, parent_frame, fig):
        ...
        # Guardar referencia para poder cerrar la figura más tarde si es necesario
        # Nota: No cerramos aquí porque el widget necesita la figura para mostrarse
    ...
    def create_invoice_status_pie(self, conteo_facturas):
        ...
        # Leyenda claramente a la izquierda (ligeramente fuera del gráfico) y donut centrado a la derecha
        ax.legend(
            labels_filt,
            loc="center left",
            bbox_to_anchor=(-0.15, 0.5),  # un poco más a la derecha para que no quede tan pegada al borde
            fontsize=12,
            frameon=True,
            framealpha=0.9,
        ...
        # Ajustar márgenes: se deja espacio razonable a la izquierda y el gráfico no queda pegado a la derecha
    ...
    def create_top_chart(self, periodos, ingresos):
        ...
        # Truncar etiquetas si son muy largas
    ...
    def create_bar_chart(self, nombres, valores):
        ...
        # Ajustar espacio según la cantidad de elementos
